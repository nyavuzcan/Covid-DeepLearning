...
dataset=np.load("datasetFourClasses.npy",allow_pickle=True)
...
model.add(keras.layers.Conv2D(filters=4, kernel_size=(3, 3), activation='relu'))
...
checkpoint = ModelCheckpoint("LeNetBest", monitor='val_accuracy', verbose=1, save_best_only=True, mode='auto')
